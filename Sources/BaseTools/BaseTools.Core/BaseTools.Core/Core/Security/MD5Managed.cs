...
namespace BaseTools.Core.Security
{
    ...
    /// <summary>
    /// Provides a managed implementation of the MD5 algorithm.
    /// </summary>
    internal class MD5Managed : HashAlgorithm
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors", Justification = "This is ported logic")]
        public MD5Managed()
        {
